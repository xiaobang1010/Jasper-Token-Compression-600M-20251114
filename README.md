...
> **Note**: This is a mirror/fork of the original [infgrad/Jasper-Token-Compression-600M](https://huggingface.co/infgrad/Jasper-Token-Compression-600M) repository. All credit goes to the original authors: Dun Zhang, Ziyang Zeng, Yudong Zhou, Shuyang Lu.
